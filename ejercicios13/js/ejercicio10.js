...
let rtotal = rgeneral+rmayores+rmenores;
 document.write(`Recaudación General: ${rgeneral} </br> Recaudacion mayores de 65: ${rmayores} </br> Recaudación menores de edad: ${rmenores} </br> Recaudación Total: ${rtotal}`)
